<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="SMMVenta.aspx.cs" Inherits="Web_Bmas_POS.MayoristaProduccion.SMMVenta" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function updText(e) {
            document.getElementById("txtTotal").innerText = e;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntMaster" runat="server">
    ...
    <br />
    <br />
    <div style="margin-left: 50px ; display: flex; align-items: center; width: 1250px; height: 200px; background-color: #d7d7d7; border-color: black; border-style: solid; border-width: 2px; justify-content:flex-start" runat="server" id="divTotalVis">
        <div style="display: inline-block ;vertical-align:central" >
             <dx:ASPxLabel ID="ASPxLabel10" runat="server"  Text="TOTAL: " Font-Size="80px" Font-Bold="True" Border-BorderStyle="None" ReadOnly="true" BackColor="#d4d4d4" Font-Names="Calibri"></dx:ASPxLabel>
        </div>
        <div display: inline-block">
              <dx:ASPxTextBox ID="txtTotal" runat="server"  Font-Size="100px" Font-Bold="True" Border-BorderStyle="None" ReadOnly="true" DisplayFormatString="N0" BackColor="#d7d7d7" Font-Names="Calibri" Width="950px" ClientInstanceName="txtTotal"></dx:ASPxTextBox>
        </div>      
    </div>
    <br />
    <br />
    <div style="margin-left: 50px" id="divPickear" runat="server">
        <div style="display:flex; align-items:center">
            <div style="display:inline-block; margin-right:100px">
                 ...
                 <dx:ASPxTextBox ID="txtDun" runat="server" Width="200px"  ViewStateMode="Disabled" CssClass="auto-style5" Theme="iOS" ClientInstanceName="txtDun" onkeypress="return EnterText(event)" AutoCompleteType="None" OnTextChanged="txtDun_TextChanged">
                     <ClientSideEvents 
            ...
            <div style="display:inline-block ; margin-top:15px ">
             ...
             <dx:ASPxCallback ID="cbLoad1" runat="server" OnCallback="ASPxCallback1_Callback" ClientInstanceName="cbload">
                 <ClientSideEvents CallbackComplete="function(s, e) {
                     txtTotal.SetText(e.result); 
                     OnEndCallback();
                      txtDun.Focus();
}"/>
                 </dx:ASPxCallback>
        ...
        <br />
                          <dx:ASPxCallback ID="ASPxCallback1" runat="server"  ClientInstanceName="cbload2" OnCallback="ASPxCallback1_Callback1">
                 <ClientSideEvents CallbackComplete="function(s, e) {
                     txtTotal.SetText(e.result);                    
}"/>
                 </dx:ASPxCallback>
        <div>
            <dx:ASPxGridView ID="GvDatos" runat="server" AutoGenerateColumns="False" DataSourceID="LinqDataSource1" EnableTheming="True" KeyFieldName="Preventa_ID;CodProducto;UniMedida" OnRowUpdating="GvDatos_RowUpdating" Theme="iOS" Width="1467px" OnRowDeleted="GvDatos_RowDeleted" OnRowCommand="GvDatos_RowCommand" OnRowUpdated="GvDatos_RowUpdated" ClientInstanceName="GvDatos" EnableViewState="False" ViewStateMode="Disabled"  OnRowDeleting="GvDatos_RowDeleting">
            
                <ClientSideEvents EndCallback="function(s, e) {
		cbload2.PerformCallback(s,e); 
}" />
                ...
                <Columns>              
                    ...
                    <dx:GridViewDataTextColumn FieldName="Preventa_ID" VisibleIndex="2" Visible="False">
                    ...
                    <dx:GridViewDataTextColumn FieldName="Cantidad" VisibleIndex="6" LoadReadOnlyValueFromDataModel="False">
                        <EditFormSettings Visible="True" />
                        <EditCellStyle BackColor="White">
                        </EditCellStyle>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="Precio" VisibleIndex="7">
                        <EditFormSettings Visible="False" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="Descuento" VisibleIndex="8">
                        <PropertiesTextEdit>
                            <ValidationSettings>
                    ...
                    <dx:GridViewDataTextColumn Caption="Medida" FieldName="UniMedida" VisibleIndex="5">
                        <EditFormSettings Visible="False" />
                    </dx:GridViewDataTextColumn>
                    ...
                    <dx:GridViewDataTextColumn Caption="N" FieldName="ByOrder" VisibleIndex="1">
                    </dx:GridViewDataTextColumn>
                </Columns>
                <TotalSummary>
     ...
     <ContentCollection>
          <dx:PopupControlContentControl runat="server" SupportsDisabledAttribute="True">
               <table width="100%">
                    ...
                    <tr>
                         <td align="center">                          
                              <a href="javascript:Yes_Click()">SI</a>
                         </td>
                         <td align="center">
